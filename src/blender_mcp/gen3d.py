...
Vendored verbatim from sphilius/game-dev-starter-kit pipeline3d/gen3d.py so the MCP
server and the headless pipeline share one client. Keep the two copies in sync.
